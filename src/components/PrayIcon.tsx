...
interface PrayIconProps {
  size?: number;
  color?: string;
}

const PrayIcon: React.FC<PrayIconProps> = ({
  size = 24,
  color = '#000000',
}) => {
  return (
    <Svg width={size} height={size} viewBox="0 0 512 512" fill="none">
      <G>
        <G>
          <Path
            d="M428.651,305.088V180.532c0-19.145-5.973-37.434-17.271-52.89L334.256,22.136l-0.342-0.452
      ...
      <G>
        <G>
          <Rect y="116.224" width="59.535" height="35.721" fill={color} />
        </G>
      </G>
      <G>
        <G>
          <Rect
            x="25.87"
            y="22.943"
            transform="matrix(0.3333 -0.9428 0.9428 0.3333 -20.5417 76.3708)"
            width="35.72"
            height="59.534"
            fill={color}
          />
      ...
      <G>
        <G>
          <Rect
            x="438.489"
            y="34.853"
            transform="matrix(0.9428 -0.3333 0.3333 0.9428 9.2062 159.0867)"
            width="59.533"
            height="35.719"
            fill={color}
          />
